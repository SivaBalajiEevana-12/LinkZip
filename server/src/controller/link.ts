...
const createUrl = async (req: any, res: any) => {
    ...
    const shortUrl = `http://localhost:3000/c/${shortCode}`;
...
const getAllLinks = async (req: any, res: any) => {
...
const getLinkById = async (req: any, res: any) => {
